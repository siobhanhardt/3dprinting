    ...
    <section id="services">
      ...
      <div className="services-2">
        <div className='col2'>
          ...
          <h2>3D Modelling</h2>
          <p>With experience using both CAD software and 3D graphics software we can help build any type of model, from a spare part to fix things around your house, to a custom model of your DND character.</p>
        </div>
        <div className='col2'>
